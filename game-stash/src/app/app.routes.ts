...
export const routes: Routes = [
  ...
  {
    path: 'player/:lobbyCode',
    redirectTo: '/mobile-join-lobby',
    pathMatch: 'full',
  },
  ...
  { path: 'desk-create-lobby', component: DeskCreateLobbyComponent },
  {
    ...
    loadComponent: () =>
      import('./mobile-join-lobby/mobile-join-lobby.component').then(
        (m) => m.MobileJoinLobbyComponent,
      ),
  },
  {
    path: 'mobile-lobby',
    loadComponent: () =>
      import('./mobile-lobby/mobile-lobby.component').then(
        (m) => m.MobileLobbyComponent,
      ),
  },
  {
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./mobile-magic-number/mobile-magic-number.component').then(
        (m) => m.MobileMagicNumberComponent,
      ),
  },
  {
    ...
    loadComponent: () =>
      import(
        './mobile-magic-number-waiting/mobile-magic-number-waiting.component'
      ).then((m) => m.MobileMagicNumberWaitingComponent),
  },
  {
    path: 'mobile-rankings',
    loadComponent: () =>
      import('./mobile-rankings/mobile-rankings.component').then(
        (m) => m.MobileRankingsComponent,
      ),
  },
